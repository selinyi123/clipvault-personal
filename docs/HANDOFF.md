...
| Current slice | **ROADMAP_V2 PR1–PR5 全部完成**（Runtime 化）。下一步：v2.1 底座 spike（Trime/Fcitx5，按 V2-S003）→ v2.2 CandidateMixer。稳定发布=v1.1.1（修配对闪退）；Full Keyboard 为实验 lab，未进稳定发布 |
| Last updated | 2026-06-20 (v1.1.1 修配对闪退；代码审查+5 修复；PR2 Facade / PR3 PanelIme / PR4 Full Keyboard Lab / PR5 spike 文档；桌面 129 绿；Builder=Claude Fable 5) |
