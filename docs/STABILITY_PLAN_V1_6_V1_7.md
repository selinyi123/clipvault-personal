...
6. **Documentation-as-release-evidence**
   ...
   - Acceptance: static tests fail if README claims unpublished v1.6 binaries,
     ...
     exists; architecture and product docs describe HTTP push/pull sync rather
     than the retired WebSocket/FastAPI plan.
