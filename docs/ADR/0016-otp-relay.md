...
4. Android first supports system Inline Autofill presentation without reading suggestion plaintext. Any
   later plaintext capture lives in the Companion Runtime, never the IME package, and needs its own
   permission/distribution evidence.
