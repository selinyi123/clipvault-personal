...
class FullKeyboardEditorActionSourceTest {
    ...
    fun editorActionIsRefreshedForEveryInputSessionAndRenderedOnTheActionKey() {
        ...
        assertTrue(source.contains("performEditorAction = { actionId -> connection.performEditorAction(actionId) }"))
        assertTrue(source.contains("sendEnter = { sendEnterKeyEvent(connection) }"))
